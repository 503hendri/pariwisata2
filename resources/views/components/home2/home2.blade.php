<div>
    ...
    <section id="destinations" class="py-16 md:py-20 w-full bg-gradient-to-b from-white to-[#F8F6F1]/50"
    ...
    <section id="news" class="py-16 md:py-20 w-full bg-gradient-to-b from-white to-[#F8F6F1]/50" data-aos="fade-up"
                ...
                @forelse($this->news as $newsItem)
                    <article
                        ...
                        <div class="relative h-60 w-full overflow-hidden rounded-xl bg-gray-100">
                            ...
                            @else
                                <div
                                    class="w-full h-full flex flex-col items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-slate-200 via-slate-300 to-slate-100 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800 text-gray-400 dark:text-gray-300 shadow-inner">
    ...
    <!-- WHY VISIT -->
    <section id="why" class="py-24 bg-[#1C1C1C] text-white" data-aos="fade-up" data-aos-duration="1000"
        data-aos-delay="500">
        <div class="max-w-7xl mx-auto px-6">
    ...
    <!-- EVENTS -->
    <section id="events" class="py-24 bg-white" data-aos="fade-up" data-aos-duration="1000"
        data-aos-delay="500">
        <div class="max-w-7xl mx-auto px-6">
    ...
    <!-- CULINARY -->
    <section id="culinary" class="py-24 bg-[#1F4D3B] text-white" data-aos="fade-up" data-aos-duration="1000"
        data-aos-delay="500">
        <div class="max-w-7xl mx-auto px-6">
    ...
    <!-- ACCOMMODATION -->
    <section id="accommodation" class="py-28 bg-gray-50" data-aos="fade-up" data-aos-duration="1000">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center mb-12">
    ...
    <!-- TESTIMONIALS -->
    <section class="py-24 bg-[#1C1C1C] text-white" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
    ...
    <!-- CONTACT -->
    <section id="contact" class="py-24 bg-white" data-aos="fade-up" data-aos-duration="1000"
        data-aos-delay="500">
